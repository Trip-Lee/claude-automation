...
> servicenow-tools@2.3.0 query
> node src/sn-unified-tracer.js query script-crud WorkClientUtilsMS

[DIRECT] Using direct file reading
[CACHE] Loaded computed cache format
Auto-detected data path: /home/coltrip/claude-automation/tools/sn-tools/ServiceNow-Tools/ServiceNow-Data/Data
Context cache loaded from /home/coltrip/claude-automation/tools/sn-tools/ServiceNow-Tools/ai-context-cache
Dependency cache loaded: 39 components, 171 APIs
[CACHE] Using pre-computed dependency cache for fast queries
{
  "success": true,
  ...
  "metadata": {
    "timestamp": "2026-01-28T02:37:55.374Z"
  }
}
```
...
> servicenow-tools@2.3.0 trace-lineage
> node src/sn-unified-tracer.js trace-lineage WorkClientUtilsMS script
...
[CACHE] Using pre-computed dependency cache for fast queries
{
  ...
  "metadata": {
    "timestamp": "2026-01-28T02:37:59.494Z",
    "confidence": {
      "level": "HIGH",
...
*Analysis Date: 2026-01-28*
*Last Updated: 2026-01-28T02:38:00Z*
