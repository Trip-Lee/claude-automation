...
class GlobalConfig {
  constructor() {
    ...
    this.defaults = {
      ...
      tasksInboxDir: join(homedir(), '.claude-tasks', 'tasks'),
      tasksCompletedDir: join(homedir(), '.claude-tasks', 'completed'),
  ...
  ensureDirectories() {
    const dirs = [
      ...
      this.config.tasksInboxDir,
      this.config.tasksCompletedDir,
      this.config.logsDir,
  ...
  static createExample(filepath) {
    const example = {
      ...
      tasksInboxDir: "~/.claude-tasks/tasks",
      tasksCompletedDir: "~/.claude-tasks/completed",
      logsDir: "~/.claude-logs",
